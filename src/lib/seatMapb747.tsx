...
export const seatMapb747: SeatMap = {
  meta: {
    count: 1,
    links: {
      self: "https://test.api.amadeus.com/v1/shopping/seatmaps?flight-orderId=eJzTd9cP8zMPCA0GAAuEAnk%3D&flightOrderId=eJzTd9cP8zMPCA0GAAuEAnk%3D",
    },
  },
  data: [
    {
      ...
      decks: [
        {
          ...
          seats: [
            ...
            },
            {
              cabin: "ECONOMY",
              number: "31D",
              characteristicsCodes: ["A", "CH", "K", "V", "1"],
              travelerPricing: [
                {
                  travelerId: "1",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "38B",
              characteristicsCodes: ["9", "CH", "E", "LS"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "AVAILABLE",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "38C",
              characteristicsCodes: ["A", "AL", "CH", "E", "LS"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "AVAILABLE",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "38E",
              characteristicsCodes: ["9", "B", "CH", "I", "K", "1"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "BLOCKED",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "38H",
              characteristicsCodes: ["A", "AL", "CH", "E", "RS"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "AVAILABLE",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "38J",
              characteristicsCodes: ["9", "CH", "E", "RS"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "AVAILABLE",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "47C",
              characteristicsCodes: ["1M", "A", "AG", "CH", "LS", "V", "1"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "BLOCKED",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "47K",
              characteristicsCodes: ["1M", "CH", "PC", "RS", "W", "1"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "BLOCKED",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "49B",
              characteristicsCodes: ["A", "CH", "E", "LS"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "AVAILABLE",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "49J",
              characteristicsCodes: ["A", "CH", "E", "RS"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "AVAILABLE",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "63J",
              characteristicsCodes: ["1M", "A", "CH", "PC", "RS"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "OCCUPIED",
