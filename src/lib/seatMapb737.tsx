...
export const seatMapb737: SeatMap = {
  meta: {
    count: 1,
    links: {
      self: "https://test.api.amadeus.com/v1/shopping/seatmaps?flight-orderId=eJzTd9cP87OIcnQGAAtuAmA%3D&flightOrderId=eJzTd9cP87OIcnQGAAtuAmA%3D",
    },
  },
  data: [
    {
      ...
      departure: {
        iataCode: "NRT",
        terminal: "1",
        at: "2024-08-31T20:55:00",
      },
      arrival: {
        iataCode: "ICN",
        terminal: "2",
        at: "2024-08-31T23:25:00",
      },
      carrierCode: "KE",
      number: "714",
      operating: {
      ...
      decks: [
        {
          ...
          seats: [
            ...
            },
            {
              cabin: "ECONOMY",
              number: "28B",
              characteristicsCodes: ["9", "B", "CH", "LS", "1"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "BLOCKED",
            ...
            },
            {
              cabin: "ECONOMY",
              number: "28C",
              characteristicsCodes: ["A", "CH", "H", "K", "LS", "1"],
              travelerPricing: [
                {
                  travelerId: "1",
                  seatAvailabilityStatus: "BLOCKED",
